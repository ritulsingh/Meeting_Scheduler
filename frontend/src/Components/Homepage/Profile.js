...
const Profile = ({ setLoginUser }) => {
    ...
    const dataUser = () => {
        axios.post("http://localhost:9002/getData", user)
            .then(res => {
        ...
        <>
            ...
            <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-2 fixed-left ms-4" id="sidenav-main">
                ...
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item mb-2">
                        <a className="nav-link active" href="#" onClick={() => history("/profile")}>
                            <div className="icon icon-shape icon-xs shadow border-radius-sm bg-gradient-light text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <main className="main-content border-radius-lg">
                    ...
                    <div className="container-fluid px-3">
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb bg-transparent mb-0 pb-1 px-0 me-sm-6 me-12">
                                <li className="breadcrumb-item"><a className="fs-2 text-dark" href="javascript:;">Profile</a></li>
                            </ol>
                        </nav>
                    </div>
                </nav>
                ...
                <div className="container-fluid">
                    <div className="page-header min-height-300 border-radius-xl mt-4" style={{ backgroundImage: 'url("../assets/img/profileBg.png")', backgroundPositionY: '50%' }}>
                    ...
                    <div className="card card-body blur shadow-blur mx-4 mt-n6">
                        <div className="row gx-4">
                            <div className="col-auto my-auto">
                                <div className="h-100">
                                    <h5 className="mb-1 fs-3">ritulsingh
                                    </h5>
                                    <h5 className="mb-1 font-weight-bold text-sm">Ritul Singh
                                    </h5>
                                    <h5 className="mb-1 font-weight-bold text-sm">
                                        <i className="fas fa-envelope" style={{ color: '#2A499C' }} />&nbsp; ritulsingh@gmail.com
                                    </h5>
                                </div>
                            </div>
                        </div>
